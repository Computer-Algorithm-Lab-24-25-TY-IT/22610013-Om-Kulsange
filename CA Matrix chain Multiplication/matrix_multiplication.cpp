...
// Function to multiply two matrices with error handling
...
// Recursive function to multiply matrices based on the optimal split
...
// Function to compute the minimum number of scalar multiplications and the optimal split points
...
int main() {
    ...
    if (n <= 0) {
        cerr << "Number of matrices must be positive." << endl;
        return 1;
    }
